...
export const fetchOffers = makeThunk(
  "content/fetchOffers",
  getOffers,
  "Failed to fetch offers",
);
export const fetchPackages = makeThunk(
  "content/fetchPackages",
  getPackages,
  "Failed to fetch packages",
);
export const fetchOffer = makeThunk(
  "content/fetchOffer",
  getOfferBySlug,
  "Failed to fetch offer",
);
export const addOffer = makeThunk(
  "content/addOffer",
  createOffer,
...
export const removeOffer = makeThunk(
  "content/removeOffer",
  deleteOffer,
  "Failed to delete offer",
);
export const addPackage = makeThunk(
  "content/addPackage",
  createPackage,
  "Failed to create package",
);

export const fetchBlogs = makeThunk(
  "content/fetchBlogs",
  getBlogs,
  "Failed to fetch blogs",
);
export const fetchBlog = makeThunk(
  "content/fetchBlog",
  getBlog,
  "Failed to fetch blog",
);
export const addBlog = makeThunk(
  "content/addBlog",
  createBlog,
...
export const removeBlog = makeThunk(
  "content/removeBlog",
  deleteBlog,
  "Failed to delete blog",
);

export const fetchFaqs = makeThunk(
  "content/fetchFaqs",
  getFaqs,
  "Failed to fetch FAQs",
);
export const addFaq = makeThunk(
  "content/addFaq",
  createFaq,
...
export const removeFaq = makeThunk(
  "content/removeFaq",
  deleteFaq,
  "Failed to delete FAQ",
);

export const fetchTestimonials = makeThunk(
  "content/fetchTestimonials",
  getTestimonials,
  "Failed to fetch testimonials",
);
export const addTestimonial = makeThunk(
  "content/addTestimonial",
  createTestimonial,
  ...
  async ({ id, formData }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        getErrorMessage(error, "Failed to update testimonial"),
      );
    }
  },
);
...
export const addPublicTicket = makeThunk(
  "content/addPublicTicket",
  createPublicTicket,
  "Ticket submit failed",
);
export const addSupportTicket = makeThunk(
  "content/addSupportTicket",
  createSupportTicket,
  "Ticket submit failed",
);

export const fetchQuizzes = makeThunk(
  "content/fetchQuizzes",
  getQuizzes,
  "Failed to fetch quizzes",
);
export const fetchQuizQuestions = makeThunk(
  "content/fetchQuizQuestions",
  getQuizQuestions,
  "Failed to fetch questions",
);
export const fetchRoadSigns = makeThunk(
  "content/fetchRoadSigns",
  getRoadSigns,
  "Failed to fetch road signs",
);
export const addQuiz = makeThunk(
  "content/addQuiz",
  createQuiz,
  "Failed to create quiz",
);
export const addQuizQuestion = makeThunk(
  "content/addQuizQuestion",
  createQuizQuestion,
  "Failed to create question",
);
export const addRoadSign = makeThunk(
  "content/addRoadSign",
  createRoadSign,
  "Failed to create road sign",
);
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchPackages.fulfilled, (state, action) => {
        state.loading = false;
        const payload = action.payload?.data || action.payload;
        state.packages = Array.isArray(payload)
          ? payload
          : payload?.packages || [];
      })
      ...
      .addCase(fetchTestimonials.fulfilled, (state, action) => {
        state.loading = false;
        const payload = action.payload?.data || action.payload;
        state.testimonials = Array.isArray(payload)
          ? payload
      ...
      .addCase(fetchQuizzes.fulfilled, (state, action) => {
        state.loading = false;
        const payload = action.payload?.data || action.payload;
        state.quizzes = Array.isArray(payload)
          ? payload
          : payload?.quizzes || [];
      })
      .addCase(fetchQuizQuestions.fulfilled, (state, action) => {
        state.loading = false;
        const payload = action.payload?.data || action.payload;
        state.quizQuestions = Array.isArray(payload)
          ? payload
          : payload?.questions || [];
      })
      .addCase(fetchRoadSigns.fulfilled, (state, action) => {
        state.loading = false;
        const payload = action.payload?.data || action.payload;
        state.roadSigns = Array.isArray(payload)
          ? payload
          : payload?.roadSigns || [];
      });
  },
