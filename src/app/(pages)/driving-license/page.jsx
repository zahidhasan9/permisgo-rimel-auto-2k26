...
const licensePackages = [
  {
    ...
    features: [
      ...
      "Code Training",
      "30 days training",
      "Support for the practical exam",
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "Code Training",
      "30 day training",
      "Support for the practical exam within 30 days",
    ],
  },
];
...
const services = [
  {
    image: service1,
    title: "Online and classroom Highway Code",
    price: "Starting from €300",
  },
  {
    image: service2,
    title: "Category B driving license, manual car",
    price: "Starting from €300",
  },
  {
    image: service3,
    title: "Automatic BCA car license",
    price: "Starting from €300",
  },
];
  ...
  return (
    <div className="flex items-center gap-1 rounded-full bg-[#edf2f9] p-1 !text-[12px] font-semibold">
      <button
        ...
        className={`rounded-full px-4 py-2 ${value === "manual" ? "bg-[#174a9b] text-white" : "text-[#5d6671]"}`}
      >
        Manual transmission
      </button>
      <button
        ...
        className={`rounded-full px-4 py-2 ${value === "automatic" ? "bg-[#174a9b] text-white" : "text-[#5d6671]"}`}
      >
  ...
  return (
    <article className="flex min-h-[610px] flex-col rounded-[10px] border-2 border-[#174a9b] bg-white px-6 py-8 transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      <div className="text-center">
        ...
        <p className="mt-1 !text-[12px] font-semibold text-[#174a9b]">
        ...
        <div className="mt-5 flex justify-center gap-3">
          {item.hours.map((hour) => (
            <span
              key={hour}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-[#174a9b] !text-[11px] font-bold text-white"
            >
              {hour}
            </span>
          ))}
      ...
      <div className="mt-7 flex items-end gap-4">
        <span className="text-[27px] font-bold text-[#174a9b]">
          {item.price}
        </span>
        <span className="pb-1 !text-[12px] text-[#737981] line-through">
          {item.oldPrice}
        </span>
      </div>
      <h4 className="mt-6 text-[17px] font-bold text-[#174a9b]">
        Package Contents
      </h4>
      <ul className="mt-5 flex-1 space-y-4">
        {item.features.map((feature, index) => (
          <li
            key={feature}
            className="flex gap-3 !text-[13px] leading-5 text-[#34383e]"
          >
      ...
      <Link
        href="/inscription"
        className="mx-auto mt-8 inline-flex min-h-[42px] min-w-[150px] items-center justify-center rounded-full border border-[#174a9b] px-6 !text-[13px] font-semibold text-[#e4213c] transition hover:bg-[#174a9b] hover:text-white"
      >
        Sign up
      </Link>
    </article>
    ...
    <article className="relative flex min-h-[555px] flex-col rounded-[10px] border-2 border-[#174a9b] bg-white px-6 py-8 transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      {item.badge && (
        <Image
          ...
          alt="Recommended"
          sizes="46px"
          className="absolute -right-2 -top-6 h-11 w-11 object-contain"
        />
      )}
      <div className="text-center">
        {item.best && (
          <p className="!text-[12px] font-semibold text-[#174a9b]">
            Best Value
          </p>
        )}
        <h3 className="mt-1 text-[25px] font-bold text-[#e4213c]">
          {item.title}
        </h3>
        <p className="mt-2 !text-[12px] font-medium text-[#4671aa]">
          Complete revision + Administrative procedures
        </p>
        <div className="mx-auto mt-5 flex min-h-[42px] max-w-[180px] items-center justify-center rounded-full border border-[#174a9b] px-4">
          <span className="text-[18px] font-bold text-[#174a9b]">
            {item.price}
          </span>
          {item.oldPrice && (
            <span className="ml-3 !text-[11px] text-[#707780] line-through">
              {item.oldPrice}
            </span>
          )}
        </div>
      </div>
      <h4 className="mt-6 text-center text-[17px] font-bold text-[#174a9b]">
        Package Contents
      </h4>
      <ul className="mt-5 flex-1 space-y-3">
        {item.features.map((feature, index) => {
          const inactive =
            item.title === "Zen Code" && index === item.features.length - 1;
          return (
            <li
              key={feature}
              className="flex gap-3 !text-[13px] leading-5 text-[#34383e]"
      ...
      <Link
        href="/inscription"
        className="mx-auto mt-7 inline-flex min-h-[40px] min-w-[150px] items-center justify-center rounded-full bg-[#e4213c] px-6 !text-[12px] font-semibold uppercase text-white transition hover:bg-[#174a9b]"
      >
        Sign Up
      </Link>
    </article>
...
export default function DrivingLicensePage() {
  ...
  const selectedOffers = filterOffers(
    cards,
  ...
  const accompaniedFeatures = copy(
    "accompaniedFeatures",
    "20 driving lessons\nAge: From 15 years old\nInitial assessment\nCode Training\nTraining follow-up by a coach\nLearning booklet\nAppointment prior to accompanied driving",
  )
    .split(/\r?\n/)
    .map((item) => item.trim())
    .filter(Boolean);
    ...
    <main className="overflow-hidden bg-white text-[#202124]">
      <section className="bg-[#eaf0f9]">
        <div className="mx-auto grid min-h-[500px] max-w-[1280px] grid-cols-[minmax(0,1fr)] items-center gap-10 px-5 py-14 sm:px-8 md:grid-cols-2 lg:px-10">
          ...
          <Image
            src={hero}
            alt="Driving lesson with an instructor"
            priority
            sizes="(max-width: 768px) 92vw, 560px"
            className="h-auto w-full max-w-[560px] justify-self-end"
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1280px]">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <h2 className="text-[32px] font-bold">
              {copy("packagesTitle", "Our Packages")}
            </h2>
            <TransmissionSwitch
              value={transmission}
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {[
              ...
              <button
                ...
                key={tab}
                className={`rounded-[7px] border px-5 py-2 !text-[12px] font-semibold ${activeTab === tab ? "border-[#174a9b] bg-[#dce8fb] text-[#174a9b]" : "border-[#d6deea] bg-white text-[#3f454c]"}`}
              >
                {tab}
              </button>
            ))}
          ...
          <div className="mt-10 grid grid-cols-[minmax(0,1fr)] gap-8 lg:grid-cols-3">
            {selectedOffers.map((item) =>
              activeTab === "Code" || activeTab === "Accompanied Driving" ? (
                <CodePackCard key={item._id} item={item} />
              ) : (
        ...
        <div className="mx-auto grid max-w-[1280px] items-center gap-10 rounded-[100px] bg-[#174a9b] px-9 py-12 text-white md:grid-cols-[1fr_300px] lg:px-[110px]">
          <div>
            <h2 className="text-[28px] font-bold">
              {copy("cpfTitle", "Get your driver's license using your CPF")}
            </h2>
            <p className="mt-4 !text-[14px] leading-6 text-white/85">
              {copy(
                "cpfDescription",
                "Permisgo is Qualiopi certified and eligible for CPF funding. Finance your driving license with your Personal Training Account.",
              )}
            </p>
            <Link
        ...
        <div className="mx-auto max-w-[1280px]">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <h2 className="text-[30px] font-bold">
              {copy("accompaniedTitle", "Our accompanied driving package")}
            </h2>
            <TransmissionSwitch
              value={transmission}
              onChange={setTransmission}
          ...
          <div className="mt-8 grid gap-10 rounded-[10px] bg-[#eaf0f9] p-7 md:grid-cols-[45%_55%] lg:p-12">
            <div className="rounded-[10px] bg-white p-7 text-center">
              <h3 className="text-[24px] font-bold text-[#e4213c]">
                {copy("accompaniedCardTitle", "Accompanied Driving")}
              </h3>
              <p className="mt-2 !text-[13px] text-[#757a81]">
                {copy("accompaniedCardSubtitle", "Code + 20 driving lessons")}
              </p>
              <div className="mt-8 flex items-end justify-between">
                <strong className="text-[25px] text-[#174a9b]">
                  {copy("accompaniedPrice", "€599*")}
                </strong>
                <span className="!text-[12px] text-[#717780] line-through">
                  {copy("accompaniedOldPrice", "€699")}
                </span>
              </div>
              <Link
            ...
            <div>
              <h3 className="text-[18px] font-bold text-[#174a9b]">
                {copy("accompaniedContentsTitle", "Package Contents")}
              </h3>
              <ul className="mt-5 grid gap-3 sm:grid-cols-2">
                {accompaniedFeatures.map((feature) => (
                  <li
                    key={feature}
                    className="flex gap-3 !text-[13px] text-[#34383e]"
                  >
                    <FaSquareCheck className="mt-1 shrink-0 text-[#174a9b]" />
                    {feature}
                  </li>
          ...
          <div className="mt-8 rounded-[10px] bg-[#eaf0f9] px-6 py-8 text-center">
            ...
            >
              {copy(
                "secondTrainingButton",
                "Discover Our Method for the Permit",
              )}
            </Link>
          </div>
        </div>
      ...
      <section className="px-5 py-20 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-[850px] text-center">
          <h2 className="text-[32px] font-bold">
            {copy("carteTitle", "Discover our à la carte offers")}
          </h2>
          <p className="mt-4 !text-[13px] text-[#777c82]">
            {copy(
              "carteDescription",
          ...
          <div className="mt-10 space-y-4 text-left">
            {singleOffers.map(([name, price]) => (
              <div
                key={name}
                className="flex min-h-[58px] items-center rounded-[9px] bg-[#eaf0f9] px-5"
              >
                <span className="flex-1 !text-[14px] font-semibold">
                  {name}
                </span>
                <span className="mr-6 !text-[13px] font-bold text-[#20ae55]">
                  {price}
                </span>
                <button
                  type="button"
                  className="rounded-full bg-[#e4213c] px-5 py-2 !text-[12px] font-semibold text-white transition hover:bg-[#174a9b]"
                >
                  Add
                </button>
              </div>
        ...
        <div className="mx-auto max-w-[1280px]">
          <div className="text-center">
            <h2 className="text-[34px] font-bold">
              {copy("codePacksTitle", "Permisgo's Highway Code Packs")}
            </h2>
            <p className="mt-4 !text-[13px] text-[#73787e]">
              {copy("codePacksDescription", "What is your need?")}
            </p>
          </div>
          <div className="mt-12 grid grid-cols-[minmax(0,1fr)] gap-9 lg:grid-cols-3">
            {codeOffers.map((item) => (
              <CodePackCard key={item._id} item={item} />
            ))}
          </div>
      ...
      <section className="px-5 py-20 sm:px-8 lg:py-24">
        <div className="mx-auto grid max-w-[1280px] items-center gap-10 rounded-[100px] bg-[#174a9b] px-9 py-12 text-white md:grid-cols-[1fr_240px] lg:px-[120px]">
          <div>
            <h2 className="text-[28px] font-bold">
              {copy("certificationTitle", "écoles de conduite labellisées")}
            </h2>
            <p className="mt-5 !text-[14px] text-white/85">
              {copy(
      ...
      <section className="px-5 pb-20 sm:px-8 lg:pb-24">
        <div className="mx-auto max-w-[1280px] text-center">
          <span className="rounded-[5px] bg-[#e7f7ec] px-4 py-2 !text-[12px] font-semibold text-[#20a657]">
            {copy("servicesLabel", "Services")}
          </span>
          <h2 className="mt-5 text-[34px] font-bold">
            {copy("servicesTitle", "All our other services")}
          </h2>
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {services.map((service, index) => (
              <article
                key={service.title}
                className="rounded-[10px] bg-[#eaf0f9] px-6 py-8 transition hover:-translate-y-1 hover:shadow-xl"
              >
                <Image
                  src={service.image}
                  alt=""
                ...
                <h3 className="mt-5 text-[17px] font-bold">
                  {copy(`service${index + 1}Title`, service.title)}
                </h3>
                <p className="mt-3 !text-[13px] text-[#3f9d5a]">
      ...
      <section className="bg-[#174a9b] px-5 py-16 sm:px-8 lg:py-20">
        <div className="mx-auto grid max-w-[1280px] gap-6 md:grid-cols-3">
          {ratingCards.map((rating, index) => (
            <article
              key={rating.title}
              className="flex min-h-[165px] flex-col items-center justify-center rounded-[20px] bg-[#f6f8fb] p-6 text-center transition hover:-translate-y-1 hover:bg-white hover:shadow-xl"
            >
              <Image
                src={rating.image}
                alt=""
              ...
              <h3 className="mt-2 text-[18px] font-bold">
                {copy(`rating${index + 1}Title`, rating.title)}
              </h3>
      ...
      <div className="hidden">
        <section className="bg-[#f5f7fa] px-5 py-20 sm:px-8 lg:py-24">
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {testimonials.map((testimonial) => (
                <article
                  ...
                  className="rounded-[10px] bg-white p-6 transition hover:-translate-y-1 hover:shadow-xl"
                >
                  <p className="!text-[13px] leading-6 text-[#50545a]">
                    Thanks to the instructors, I passed my driving test on the
                    first try. The lessons were clear and very helpful!
                  </p>
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="!text-[12px] text-[#747981]">
                        Web Designer
                      </p>
                    </div>
                  </div>
            ...
            <Link
              href="/reviews"
              className="mt-10 inline-flex rounded-[8px] bg-[#e4213c] px-6 py-3 !text-[13px] font-semibold text-white transition hover:bg-[#174a9b]"
            >
              View All
            </Link>
          </div>
